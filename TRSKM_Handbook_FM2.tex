...
\vfill
\begin{minipage}[h]{0.5\linewidth}
\center{\includegraphics[width = 1\linewidth]{mountSample2} \\ e)}
\end{minipage}
\hfill
\begin{minipage}[h]{0.5\linewidth}
\center{\includegraphics[width = 1\linewidth]{mountSample3} \\ f)}
...
\begin{figure}
\begin{minipage}[h]{0.5\linewidth}
\center{\includegraphics[width = 1\linewidth]{mountSample4} \\ a)}
\end{minipage}
\hfill
\begin{minipage}[h]{0.5\linewidth}
\center{\includegraphics[width = 1\linewidth]{mountSample5} \\ b)}
\end{minipage}
\vfill
...
\vfill
\begin{minipage}[h]{0.3\linewidth}
\center{\includegraphics[width = 1\linewidth]{mountSample8} \\ e)}
\end{minipage}
\hfill
\begin{minipage}[h]{0.55\linewidth}
\center{\includegraphics[width = 1\linewidth]{mountSample9} \\ f)}
\end{minipage}

\caption{Sample installation}
\label{fig:sampleInstall2}
\end{figure}


%\begin{figure}
%\begin{minipage}[h]{0.5\linewidth}
%\center{\includegraphics[width = 1\linewidth]{mountSample10} \\ a)}
%\end{minipage}
%\hfill
%\begin{minipage}[h]{0.5\linewidth}
%\center{\includegraphics[width = 1\linewidth]{mountSample10} \\ b)}
%\end{minipage}
%\vfill
%\caption{Sample installation}
%\label{fig:sampleInstall3}
%\end{figure}
